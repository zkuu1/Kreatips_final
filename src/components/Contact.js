     ...
     return (
        <section className="py-20 bg-gray-100" id="contact">
            <div className="container mx-auto text-center">
                ...
                <a href="mailto:zakarisemarang33@gmail.com" className="bg-customGreen hover:bg-customLightGreen text-white font-bold py-2 rounded-lg shadow-md transition duration-300 px-4">
                    Email saya
                </a>
            </div>
        </section>
